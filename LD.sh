...
vcftools --gzvcf ${FILE} --chr ${1} --geno-r2 --thin 1000 --maf 0.05 --max-missing 0 --out ${DIR}/${1}
...
vcftools --gzvcf ${FILE} --keep ${D01_list} --chr ${1} --geno-r2 --thin 1000 --maf 0.05 --max-missing 0 --out ${DIR}/D01_${1}
cat ${DIR}/D01_${1}.geno.ld | perl /QRISdata/Q6656/reformat/emerald2windowldcounts.pl > ${DIR}/D01_${1}_ld.txt
rm ${DIR}/D01_${1}.geno.ld

# calculate LD and convert to table for H01
H01_list="/home/uqkmcla4/scripts/avneet/H01.txt"
vcftools --gzvcf ${FILE} --keep ${H01_list} --chr ${1} --geno-r2 --thin 1000 --maf 0.05 --max-missing 0 --out ${DIR}/H01_${1}
cat ${DIR}/H01_${1}.geno.ld | perl /QRISdata/Q6656/reformat/emerald2windowldcounts.pl > ${DIR}/H01_${1}_ld.txt
